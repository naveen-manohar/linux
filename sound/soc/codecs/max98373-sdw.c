...
static void max98373_read_config(struct sdw_slave *slave)
{
	...
	struct max98373_sdw_priv *max98373 = dev_get_drvdata(dev);
...
static int max98373_read_prop(struct sdw_slave *slave)
{
	...
	prop->source_ports = 0x08;
	/* BITMAP: 00000010  Dataport 1 is active */
	prop->sink_ports = 0x02;
...
static int max98373_io_init(struct sdw_slave *slave)
{
	...
	regmap_write(max98373->regmap, MAX98373_R20FF_GLOBAL_SHDN, 0);
	/* Set soundwire mode */
	...
	regmap_write(max98373->regmap, MAX98373_R203D_AMP_DIG_VOL_CTRL, 0);
	/* Enable speaker */
	regmap_write(max98373->regmap, MAX98373_R2043_AMP_EN, 3);
	...
	/* Amp enable */
	regmap_write(max98373->regmap, MAX98373_R20FF_GLOBAL_SHDN, 1);
...
{
	struct max98373_sdw_priv *max98373 =
	...
	struct sdw_bus_params *params)
{
	...
	/* Enable the codec - Play the audio after 4 ms */
	regmap_write(max98373->regmap, MAX98373_R20FF_GLOBAL_SHDN, 0x01);
	...
	struct snd_soc_dai *dai)
{
	...
	port_config.ch_mask = (1 << (stream_config.ch_count)) - 1;
...
{
	struct max98373_sdw_priv *max98373 = dev_get_drvdata(&slave->dev);

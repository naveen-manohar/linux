...
static int max98373_io_init(struct sdw_slave *slave)
{
	...
	value = 0x80; regmap_write(max98373->regmap, MAX98373_R2029_PCM_TO_SPK_MONO_MIX_1, value);	// Mono Mix 1
	value = 0x01; regmap_write(max98373->regmap, MAX98373_R202A_PCM_TO_SPK_MONO_MIX_2, value);	// Mono Mix 2
	...
	value = 0x08; regmap_write(max98373->regmap, MAX98373_R203E_AMP_PATH_GAIN, value);		// Set SPKR Gain and Voltage
...
static int max98373_clock_config(struct sdw_slave *slave, struct sdw_bus_params *params)
{
	...
	*/
	...
	dev_info(&slave->dev, "SounwWire Control: 0x%x\n", value);
...
#define MAX98373_RATES 				SNDRV_PCM_RATE_48000

#define MAX98373_PLAYBACK_FORMATS 	SNDRV_PCM_FMTBIT_S32_LE
#define MAX98373_RECORD_FORMATS 	SNDRV_PCM_FMTBIT_S16_LE
...
static struct snd_soc_dai_driver max98373_dai[] = {
	{
		...
		.playback = {
			...
			.formats = MAX98373_PLAYBACK_FORMATS,
		},
		.capture = {
			...
			.channels_max = 2,
			.rates = MAX98373_RATES,
			.formats = MAX98373_RECORD_FORMATS,
		},
